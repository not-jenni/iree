// RUN: iree-opt -split-input-file -iree-codegen-split-dispatch-function %s | IreeFileCheck %s
...
// Do not split when Linalg ops are not directly operating on interface buffers.
...
module {
  ...
  func @kernel() {
    ...
    %1 = iree.placeholder for "interface buffer" {binding = @legacy_io::@arg1} : memref<3x3x512x1xf32>
    %2 = iree.placeholder for "interface buffer" {binding = @legacy_io::@ret0} : memref<1x1x1x512xf32>
    %view = subview %1[][][] : memref<3x3x512x1xf32> to memref<3x3x512x1xf32>
    linalg.conv(%view, %0, %2) {dilations = [1, 1], padding = dense<[[0, 1], [0, 1]]> : tensor<2x2xi64>, strides = [2, 2]} : memref<3x3x512x1xf32>, memref<1x2x2x512xf32>, memref<1x1x1x512xf32>
    return
  }
  hal.interface @legacy_io attributes {sym_visibility = "private"} {
    hal.interface.binding @arg0, set=0, binding=0, type="StorageBuffer", access="Read"
