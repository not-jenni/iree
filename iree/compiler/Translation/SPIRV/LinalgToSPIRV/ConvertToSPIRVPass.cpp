...
spirv::PointerType getPushConstantStorageType(unsigned elementCount,
                                              Builder &builder) {
  // TODO(antiagainst): we are assuming all dimensions are sent as 32-bit
  // integer values here. Should set by the runtime.
  auto arrayType = spirv::ArrayType::get(builder.getIntegerType(32),
                                         elementCount, /*stride=*/4);
