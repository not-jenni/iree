...
//===- MarkerUtils.h - Methods that set markers on Linalg op --------------===//
//
...
/// Set marker to prevent tiling of a linalg operation.
void setNoTileMarker(Operation *);

/// Set marker to denote that a linalg operation is to be partitioned to
/// workitems.
