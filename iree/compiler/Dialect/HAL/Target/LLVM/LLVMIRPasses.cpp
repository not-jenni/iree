...
std::unique_ptr<llvm::TargetMachine> createTargetMachine(
  ...
  // TODO(ataei): Once we have an AOT backend pass mcpu, CodeMode..etc.
  std::unique_ptr<llvm::TargetMachine> machine(
      target->createTargetMachine(options.targetTriple, "generic", "", {}, {}));
  return machine;
}

LogicalResult buildLLVMIRPasses(const LLVMTargetOptions& options,
                                std::unique_ptr<llvm::TargetMachine> machine,
                                llvm::Module* module) {
